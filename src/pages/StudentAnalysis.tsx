    ...
    <div className="min-h-screen paper-texture p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-primary mb-1">AI Analysis Complete</h1>
        ...
        <Card className="p-6 bg-gradient-to-br from-accent/10 to-primary/10 border-accent/30 shadow-card">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-semibold mb-2">AI Has Analyzed Your Work</h2>
        ...
        <Card className="p-6 shadow-card">
          <h2 className="text-2xl font-semibold mb-4">Your Work with AI Highlights</h2>
