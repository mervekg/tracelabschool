      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="signin">
            <form onSubmit={handleSignIn} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="signin-email" className="text-primary">Email Address*</Label>
                <Input
                  id="signin-email"
                  type="email"
                  placeholder=""
              ...
              {/* Create Account and Forgot links */}
              ...
              {/* Google Sign In Button - Colorful Logo */}
              <div className="flex justify-center">
                <button
                  type="button"
                  onClick={handleGoogleSignIn}
                  disabled={googleLoading || loading}
                  className="w-12 h-12 rounded-full bg-muted/50 border border-border flex items-center justify-center hover:bg-muted transition-colors disabled:opacity-50"
                >
          ...
          <TabsContent value="signup">
            {/* Google Sign Up Button - Colorful Logo */}
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="signup-email" className="text-primary">Email Address*</Label>
                <Input
                  id="signup-email"
                  type="email"
                  placeholder=""
              ...
              <div className="space-y-2">
                <Label htmlFor="signup-confirm-password" className="text-primary">Confirm Password*</Label>
                <div className="relative">
                  <Input
